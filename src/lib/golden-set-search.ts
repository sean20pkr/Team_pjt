...
const ENTRIES: GoldenSetEntry[] = [
  ...
  { id: "F1", type: "forecast", question: "2026년 6월 전사 월초 전망의 중심값과 범위를 제시해줘.", answer: "현재 실제 데이터는 2026년 5월까지이며, 다음 달 전사 월초은 261.8 내외, 범위는 259.0~264.6 정도로 보는 편이 안전합니다.", keywords: ["전사 월초", "전망", "중심값", "범위"] },
